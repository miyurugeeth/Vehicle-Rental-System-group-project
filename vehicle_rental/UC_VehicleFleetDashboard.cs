...
namespace vehicle_rental
{
    public partial class UC_VehicleFleetDashboard : UserControl
    {
        ...
        private void UC_VehicleFleetDashboard_Load(object sender, EventArgs e)
        {
            ...
            // 🎯 [🎯 විසඳුම - කේතයෙන්ම Anchor සකස් කිරීම]
            // 1. දත්ත පෙන්වන Grid එක දිශා හතරටම (තිරස්ව සහ සිරස්ව) ලස්සනට ඇදී විශාල වීමට:
            dgvVehicles.Anchor = AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left | AnchorStyles.Right;

            // 2. දත්ත ඇතුළත් කරන පැනලය දකුණු පසින්ම රඳවාගෙන, සිරස්ව (උඩ සහ පහළ) පමණක් විශාල වීමට:
            Panel_Form.Anchor = AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Right;

            // දත්ත දත්ත සමුදායෙන් පූරණය කිරීම
            LoadVehicleData();
        }
