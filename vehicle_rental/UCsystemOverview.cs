...
namespace vehicle_rental
{
    public partial class UC_DashboardOverview : UserControl
    {
        ...
        #region 🗄️ DATABASE DATA FETCHING

        private void LoadDashboardCounts()
        {
            try
            {
                // Get counts from database (Using corrected DatabaseHelper class)
                ...
                // Update labels inside the User Control
        ...
        // 3. Get Return Count (Total number of completed returns - today)
        ...
        #region 🔄 REFRESH & INTERACTION EVENTS

        // Refresh button click handler inside User Control
        private void btnRefresh_Click(object sender, EventArgs e)
        {
            LoadDashboardCounts();
        }

        // Timer to auto-refresh every 30 seconds inside User Control
        private void timer1_Tick(object sender, EventArgs e)
        {
            LoadDashboardCounts();
        }

        // Placeholders for visual controls layout mapping
